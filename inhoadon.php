...
<head>
    ...
    <meta content="Hệ thống quản lý truy xuất nguồn gốc trang trại Anova Shop" />
    <link href="assets/css/hoadon.css" rel="stylesheet" />
</head>
<body>
<table style="border:1px solid;">
	<tr>
		<td rowspan="3" class="title">
			<input type="text" value="<?php echo $user_default['person']; ?>" class="title" />
		</td>
				...
				<tr>
					<td width="100" rowspan="4" colspan="2" align="center" style="border:0px;">
						<?php if(isset($ht['logo_left']) && $ht['logo_left']): ?>
                        	<img src="image.php?id=<?php echo $ht['logo_left']; ?>" width="100"/>
	                    <?php else: ?>
	                        <img src="images/hoadon1.png" width="100"/>
	                    <?php endif; ?>
					</td>
					...
					<td width="106" rowspan="4" style="border:0px !important;">
						<?php if(isset($ht['logo_right']) && $ht['logo_right']): ?>
                        	<img src="image.php?id=<?php echo $ht['logo_right']; ?>" width="100"/>
	                    <?php else: ?>
	                        <img src="images/hoadon2.png" width="100"/>
	                    <?php endif; ?>
					</td>
				</tr>
				<tr>
